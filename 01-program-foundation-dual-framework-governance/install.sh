#!/usr/bin/env bash
# CloudNimbus Trust Programme — Phase 01 local setup
set -euo pipefail
HERE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
echo "Phase 01 — Programme Foundation & Dual-Framework Governance"
echo "Location: $HERE"
echo
echo "Numbered documents:"; ls -1 "$HERE"/01.*.md | sed 's|.*/|  |'
echo
