#!/usr/bin/env bash
# CloudNimbus Trust Programme — Phase 02 local setup
set -euo pipefail
HERE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
echo "Phase 02 — System Scope, ISMS Boundary & Description"
echo "Location: $HERE"
echo
echo "Numbered documents:"; ls -1 "$HERE"/02.*.md | sed 's|.*/|  |'
echo
