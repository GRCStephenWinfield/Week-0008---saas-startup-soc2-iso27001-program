#!/usr/bin/env bash
# CloudNimbus Trust Programme — Phase 03 local setup
set -euo pipefail
HERE="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
echo "Phase 03 — Risk Assessment, Treatment & Statement of Applicability"
echo "Location: $HERE"
echo
echo "Numbered documents:"; ls -1 "$HERE"/03.*.md | sed 's|.*/|  |'
echo
